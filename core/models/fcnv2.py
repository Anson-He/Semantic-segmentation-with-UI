...
__all__ = ['FCN', 'get_fcn', 'get_fcn_resnet50_voc','get_fcn_resnet50_citys',
...
def get_fcn(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='../../models',
    ...
    if pretrained:
        ...
        print('fcn_%s_%s' % (backbone, acronyms[dataset]))
...
def get_fcn_resnet50_citys(**kwargs):
    return get_fcn('citys', 'resnet50', **kwargs)
