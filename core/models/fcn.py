...
from .base_models.resnet import resnet50

__all__ = ['get_fcn32s', 'get_fcn16s', 'get_fcn8s',
           'get_fcn32s_vgg16_voc', 'get_fcn16s_vgg16_voc', 'get_fcn8s_vgg16_voc',
           'get_fcn32s_vgg16_citys', 'get_fcn16s_vgg16_citys', 'get_fcn8s_vgg16_citys']
...
def get_fcn32s(dataset='pascal_voc', backbone='vgg16', pretrained=False, root='../models',
...
def get_fcn16s(dataset='pascal_voc', backbone='vgg16', pretrained=False, root='../models',
               pretrained_base=True, **kwargs):
    acronyms = {
        'pascal_voc': 'pascal_voc',
        'pascal_aug': 'pascal_aug',
...
def get_fcn8s(dataset='pascal_voc', backbone='vgg16', pretrained=False, root='../models',
              pretrained_base=True, **kwargs):
    acronyms = {
        'pascal_voc': 'pascal_voc',
        'pascal_aug': 'pascal_aug',
...
def get_fcn32s_vgg16_citys(**kwargs):
    return get_fcn32s('citys', 'vgg16', **kwargs)


def get_fcn16s_vgg16_citys(**kwargs):
    return get_fcn16s('citys', 'vgg16', **kwargs)


def get_fcn8s_vgg16_citys(**kwargs):
