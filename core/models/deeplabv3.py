...
__all__ = ['DeepLabV3', 'get_deeplabv3', 'get_deeplabv3_resnet50_voc', 'get_deeplabv3_resnet101_voc',
           'get_deeplabv3_resnet152_voc', 'get_deeplabv3_resnet50_citys', 'get_deeplabv3_resnet101_ade',
...
def get_deeplabv3(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='../models',
...
def get_deeplabv3_resnet50_citys(**kwargs):
    return get_deeplabv3('citys', 'resnet50', **kwargs)
