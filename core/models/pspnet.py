...
__all__ = ['PSPNet', 'get_psp', 'get_psp_resnet50_voc', 'get_psp_resnet50_ade', 'get_psp_resnet101_voc',
           'get_psp_resnet101_ade', 'get_psp_resnet101_citys', 'get_psp_resnet101_coco', 'get_psp_resnet50_citys']
...
def get_psp(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='../models',
...
def get_psp_resnet50_citys(**kwargs):
    return get_psp('citys', 'resnet50', **kwargs)
